...
settings = {
    ...
    "message":"บัญชีนี้ถูกป้องกันโดย ꧁❀のุʨҨ₪ิ७ℓখ็πখี่❀꧂ ระบบได้บล็อคคุณอัตโนมัติ!",
    "comment":"""꧁❀のุʨҨ₪ิ७ℓখ็πখี่❀꧂:
╔══════════════┓
╠       ꧁❀のุʨҨ₪ิ७ℓখ็πখี่❀꧂
╚══════════════┛""",
    "userAgent": [
...
#==============================================================================#
                    ...
                    start = time.time()
                    line.sendMessage(to, "꧁❀のุʨҨ₪ิ७ℓখ็πখี่❀꧂")
...
#==============================================================================#
                    ...
                    msg.contentType = 13
                    line.sendMessage(to, "「 ผู้สร้างบอท 」")
                    line.sendContact(to, "u51f2d901e6ae79ea2649062da18176df")
                    line.sendContact(to, "u51f2d901e6ae79ea2649062da18176df")
                    line.sendContact(to, "u51f2d901e6ae79ea2649062da18176df")
                    line.sendContact(to, "u51f2d901e6ae79ea2649062da18176df")
                    line.sendContact(to, "u51f2d901e6ae79ea2649062da18176df")
...
#==============================================================================#
                    ...
                    me = line.getContact(lineMID)
                    line.sendVideoWithURL(msg.to,"http://dl.profile.line-cdn.net/" + me.pictureStatus + "/Yo")
                elif text.lower() == 'ปก':
                    me = line.getContact(lineMID)
...
#===================================================================#              
                    ...
                    if receiver in read['readPoint']:
                        ...
                        line.sendMessage(receiver,"ไม่ต้องแอบ ออกมาเย็ดกัน \n(^人^) ")                
#==============================================================================#
#=============================================#                    
...
#==============================================================================#
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         ...
                         line.sendMessage(msg.to, "꧁❀のุʨҨ₪ิ७ℓখ็πখี่❀꧂\n❋ตั้งข้อความเมื่อมีคนแอด❋\n\n{}".format(str(spl)))
